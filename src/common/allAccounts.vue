<template>
	<div class="shift">
		...
		<div class="box" v-for="(item, index) in allOrder" :key='index' v-else :class="{'states1': item.status === '1', 'states2': item.status ==='2', 'states3': item.status ==='3', 'states4': item.status ==='100' , 'states5': item.status ==='0' }"   @click='showDetailInfo(item.bill_id, item.type)'>
			<div>
